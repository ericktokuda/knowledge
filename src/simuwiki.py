...
def run_experiment(params):
    ...
    # lens = lens[np.triu_indices(g.vcount())]
    # diam = g.diameter()
    # vltr = np.array(g.as_undirected().transitivity_local_undirected())
    # valid = np.argwhere(~np.isnan(vltr)).flatten()
    # vltr = vltr[valid]
    # betw = g.betweenness()
    # print('{},{},{},{},{:.02f},{:.02f},{:.02f},{:.02f},{}'.format(
        # model,
        # nvertices,
        # avgdegree,
        # g.vcount(),
